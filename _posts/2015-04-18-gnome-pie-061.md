...
* **New Feature:** Thanks to Gabriel Dubatti its now possible to define a maximum number of slices per pie. If there are more, you have the possibility to scroll through the pie with your mouse wheel or Page-Up & Page-Down
...
* **Bugfix:** The faked background transparency for desktop environments without compositing works now also close to panels and when the mouse moved while opening pies.
...
* **Bugfix:** Changed WM_CLASS which enabled launchers to track windows properly.
