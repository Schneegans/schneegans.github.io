...
<div class="wp-caption-text">Correlation between item count and selection time in Gnome-Pie</div>
<img src="{{site.url}}/assets/pictures/bachelor/bachelor10.jpg" alt="" title="bachelor06" class="aligncenter size-full clean" />
...
<div class="wp-caption-text">Density functions of selection time done with Gnome-Pie by 150 users</div>
<img src="{{site.url}}/assets/pictures/bachelor/bachelor09.jpg" alt="" title="bachelor06" class="aligncenter size-full clean" />
...
<div class="wp-caption-text">Prototype search performance for different menu configurations compared to the linear menu</div>
<img src="{{site.url}}/assets/pictures/bachelor/bachelor06.jpg" alt="" title="bachelor06" class="aligncenter size-full clean" />
...
<div class="wp-caption-text">Menu performance for consecutive selections of the same item</div>
<img src="{{site.url}}/assets/pictures/bachelor/bachelor07.jpg" alt="" title="bachelor06" class="aligncenter size-full clean" />
...
<div class="wp-caption-text">Menu performance for multiple selections of the same item distributed over six training sessions</div>
<img src="{{site.url}}/assets/pictures/bachelor/bachelor08.jpg" alt="" title="bachelor06" class="aligncenter size-full clean" />
...
<img src="{{site.url}}/assets/pictures/bachelor/coral_paths.jpg" alt="" title="Cursor movement of users of the Coral-Menu. Green dots visualize mouse clicks." width="688" height="137" class="aligncenter size-large" />

<img src="{{site.url}}/assets/pictures/bachelor/trace_paths.jpg" alt="" title="Cursor movement of users of the Trace-Menu. Green dots visualize mouse clicks." width="688" height="249" class="aligncenter size-large" />
